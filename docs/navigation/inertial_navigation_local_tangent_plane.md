        ...
        <div class="flex-row">
            <div class="flex-item">
              ...
              <p class="text">
                ...
                &= \mathbf{R}^l_b(t) \exp\left( \left[ \boldsymbol{\alpha}^b_{ib} \right]_\times \right) - \left[ \exp\left( \boldsymbol{\Omega}^l_{il} \tau_i \right) - \mathbf{I}_3 \right] \mathbf{R}^l_b(t) \\
