...
Euler angles can be converted to rotation and transformation matrices described in [Transformation and Rotation Matrices]("/kinematics/attitude_transformation_and_rotation_matrix").
